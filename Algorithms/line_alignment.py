"""
Задана последовательность слов и целое число k длина строки,
верните список строк, которые представляют каждую строку,
полностью выровненную. Пример:
...
print(line_alignment(["the", "quick", "brown", "fox", "jumps", "over", "the", "lazy", "dog"], 16))